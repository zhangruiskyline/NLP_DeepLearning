...
- [Project 1: Spam detector](#project-1-spam-detector)
- [project 2: sentiment analysis](#project-2-sentiment-analysis)
- [Section 1 : NLTK](#section-1--nltk)
  - [nltk download corresponding packages](#nltk-download-corresponding-packages)
  - [Pos Tag](#pos-tag)
  - [Stemming and Lemmatization](#stemming-and-lemmatization)
  - [Token](#token)
- [Section 2: Latent Semantic Analysis(LSA)](#section-2-latent-semantic-analysislsa)
  - [underline Math for LSA](#underline-math-for-lsa)
    - [SVD](#svd)
  - [Example of LSA on Book Title](#example-of-lsa-on-book-title)
- [Section 3: Word embedding](#section-3-word-embedding)
  - [word analogies](#word-analogies)
- [TF-IDF and t-SNE](#tf-idf-and-t-sne)
- [Section 4: Word2vec](#section-4-word2vec)
  - [Main idea:](#main-idea)
    - [Two efficient training methods](#two-efficient-training-methods)
  - [Continuous Bag of Words (CBOW)](#continuous-bag-of-words-cbow)
  - [The Skip-Gram Model](#the-skip-gram-model)
    - [Skip gram in example: word pairs](#skip-gram-in-example-word-pairs)
    - [Model Details](#model-details)
    - [Hidden layer](#hidden-layer)
    - [Output](#output)
    - [skip gram model in real](#skip-gram-model-in-real)
    - [Intuition](#intuition)
    - [Negative sampling](#negative-sampling)
    - [Cost function with negative sampling](#cost-function-with-negative-sampling)
  - [Word2vec Application](#word2vec-application)
    - [How to train](#how-to-train)
- [Section 2: NLP Common Pre-Process Techs](#section-2-nlp-common-pre-process-techs)
  - [Documentation Matrix](#documentation-matrix)
  - [General Concept:](#general-concept)
  - [TF-IDF](#tf-idf)
    - [Term Frenquency](#term-frenquency)
    - [The inverse document frequency (IDF) weight](#the-inverse-document-frequency-idf-weight)
    - [Python Example](#python-example)
- [Section 3 : Naive Bayes](#section-3--naive-bayes)
  - [What is Naive Bayes algorithm?](#what-is-naive-bayes-algorithm)
  ...
  - [Naive Bayes in Python and sklearn lib](#naive-bayes-in-python-and-sklearn-lib)
  - [Improvement](#improvement)
- [Section 4: LDA](#section-4-lda)
  - [Topic model](#topic-model)
  - [LDA Understanding](#lda-understanding)
  - [LDA Python Lib](#lda-python-lib)
  - [The whole process system](#the-whole-process-system)
  - [Reference](#reference)
- [Section 5: Deep Learning NLP](#section-5-deep-learning-nlp)
  - [Dataset](#dataset)
    - [Pos Tag dataset](#pos-tag-dataset)
    - [NER dataset](#ner-dataset)
- [RNN Intro](#rnn-intro)
  - [Parse Tree](#parse-tree)
- [Python 3 change](#python-3-change)
